 ...
 * @author rui-d-pedro
 */
@Table(name = DefaultConfig.CASSANDRA_TABLE_COUNTERS)
public class Counter extends BaseModel implements Comparable {
	...
	private Map<String, Double> dataDefinition;
	 ...
	 */
	public Counter(String resourceType, Date timestamp, String resourceID, String reporterID, String counterType, Map<String, String> resourceDescription, Map<String, Double> dataDefinition, Map<String, String> reporterDescription) throws IllegalArgumentException {
		validate(resourceType, timestamp, resourceID, reporterID, resourceDescription, dataDefinition, reporterDescription);
	 ...
	 * @throws IllegalArgumentException
	 */
	private void validate(String resourceType, Date timestamp, String resourceID, String reporterID, Map<String, String> resourceDescription, Map<String, Double> dataDefinition, Map<String, String> reporterDescription) throws IllegalArgumentException {
	...
	public Map<String, Double> getDataDefinition() {
		return dataDefinition;
	}

	public void setDataDefinition(Map<String, Double> dataDefinition) {
		this.dataDefinition = dataDefinition;
	}
	...
	public static void setTable(String tablename) {
		try {
			Annotation originalAnnotation = Counter.class.getDeclaredAnnotation(Table.class);
	...
	public int compareTo(Object o) {
		if (o instanceof Counter) {
			return this.getUuid().compareTo(((Counter) o).getUuid());
		}
		return -1;
	}
}
